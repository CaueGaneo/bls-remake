...
function initSupabase() {
  if (!window.supabase || !window.supabase.createClient) {
    console.error("Supabase não carregou corretamente.");
    return false;
  }
...
async function carregarPlayers() {
  if (!supabase) {
    console.warn("Supabase indisponível. Ranking não será carregado.");
    return;
  }
...
// Garante que as funções fiquem acessíveis no onclick do HTML
